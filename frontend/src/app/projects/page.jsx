    ...
    <PageTransition>
      <div className="min-h-screen bg-[#191120]">
        ...
        <div className="flex max-w-[1400px] mx-auto px-8 py-10 gap-10">
          {/* Sidebar */}
          <aside className="w-72 flex-shrink-0 animate-on-scroll opacity-0">
          ...
          {/* Main Content */}
          <main className="flex-1 animate-on-scroll opacity-0">
            {/* Search Bar */}
            ...
            {loading ? (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {[...Array(6)].map((_, i) => (
                  <div
                    key={i}
                    className="h-72 bg-[#2a2a3e] rounded-lg animate-pulse"
                  />
                ))}
              </div>
            ) : (
